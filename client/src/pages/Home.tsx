      ...
      <div className="p-4 pb-safe">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-4 mb-8 px-2">
            <Link href="/kakao">
              <Card className="p-6 active:scale-[0.98] transition-all cursor-pointer border-2 hover:border-yellow-400 group w-full">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 flex-shrink-0 rounded-full bg-yellow-100 flex items-center justify-center group-hover:bg-yellow-200 transition-colors">
            ...
            <Link href="/ogq">
              <Card className="p-6 active:scale-[0.98] transition-all cursor-pointer border-2 hover:border-green-400 group w-full">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 flex-shrink-0 rounded-full bg-green-100 flex items-center justify-center group-hover:bg-green-200 transition-colors">
                    <span className="text-4xl font-bold text-green-600">N</span>
                  </div>
                  <div className="flex-1 text-left">
                    <h2 className="text-xl font-bold text-gray-800 mb-2">
                      네이버 OGQ
